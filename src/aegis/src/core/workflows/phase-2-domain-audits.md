...
@~/.claude/aegis/core/agents/architect.md
@~/.claude/aegis/core/agents/data-engineer.md
@~/.claude/aegis/core/agents/security-engineer.md
@~/.claude/aegis/core/agents/compliance-officer.md
@~/.claude/aegis/core/agents/senior-app-engineer.md
@~/.claude/aegis/core/agents/sre.md
@~/.claude/aegis/core/agents/performance-engineer.md
@~/.claude/aegis/core/agents/test-engineer.md
